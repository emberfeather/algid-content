component extends="algid.inc.resource.base.event" {
	public void function onUpdate( required struct transport, required component collection ) {
		...
		if(local.content.recordCount) {
			index action="update" collection="#arguments.collection.getName()#" type="custom" query="local.content" key="contentID" body="content" title="title" category="content" categoryTree="path" urlPath="path";
